...
function themify_theme_magazine_google_fonts( $fonts ) {
	$fonts = array();
	...
	if ( 'off' !== _x( 'on', 'FiraSans font: on or off', 'themify' ) ) {
		$fonts['fira-sans'] = 'Fira+Sans:400,500,600,700';
	}
	return $fonts;
}
add_filter( 'themify_theme_google_fonts', 'themify_theme_magazine_google_fonts' );